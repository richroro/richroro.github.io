...
/* ---------------------------------------------------------------- 1 */
{
  ...
  lessons: [
    ['신용이 첫 자본', '돈이 없던 배달꾼이 가게를 물려받은 이유는 장부와 창고였다.', 1, '돈이 없으면 장사를 못 한다고 생각한다'],
    ['실패는 수업료', '불탄 공장 앞에서 그가 한 일은 다시 빌리고, 더 빨리 고치는 것이었다.', 2, '공장이 불타면 거기서 멈춘다'],
    ['없는 것을 핑계로 멈추지 않기', '조선소도 없이 모래사장 사진으로 배를 팔았다.', 3, '조선소부터 지어야 배를 팔 수 있다고 생각한다']
  ],
  timeline: [
...
/* ---------------------------------------------------------------- 2 */
{
  ...
  lessons: [
    ...
    ['모르면 가장 잘 아는 사람에게', '1년 동안 전문가를 찾아다니며 산업 지도를 새로 그렸다.', 2, '모르는 분야는 처음부터 피한다'],
    ['아무도 없는 시장', '특허 만료라는 날짜가 정해진 기회를 먼저 봤다.', 4, '남들이 이미 돈 버는 시장에 뛰어든다']
  ],
  timeline: [
...
/* ---------------------------------------------------------------- 3 */
{
  ...
  lessons: [
    ...
    ['정점에서 떠날 용기', '최대 인터넷 회사를 떠나 스마트폰 시대에 다시 창업했다.', 3, '잘나갈 때는 자리를 지킨다']
  ],
  timeline: [
...
/* ---------------------------------------------------------------- 4 */
{
  ...
  lessons: [
    ['실패도 자산이 된다', '팔리지 않던 가구점의 디자인 감각이 배민의 브랜드가 됐다.', 3, '망한 가게는 잊고 싶은 과거로 남긴다'],
    ['불편함이 곧 시장', '온 집을 뒤지게 만들던 전단지가 사업 아이템이었다.', 2, '불편해도 원래 그런 거라며 넘어간다'],
    ['손으로 먼저', '데이터가 없으면 직접 주워 입력했다. 확장은 그다음이었다.', 2, '데이터가 없으면 시작을 못 한다고 생각한다']
  ],
  timeline: [
...
/* ---------------------------------------------------------------- 5 */
{
  ...
  lessons: [
    ['빨리, 많이 실패하기', '여덟 번의 실패가 아홉 번째를 위한 연습이었다.', 1, '한 번 실패하면 창업은 안 맞는다고 결론 낸다'],
    ['답은 사용자 입에서', '만들고 싶은 것 대신, 사람들이 화내는 지점을 찾았다.', 2, '내가 만들고 싶은 것부터 만든다'],
    ['규제는 벽이자 해자', '먼저 넘은 벽은 뒤따라오는 경쟁자를 막아 준다.', 3, '규제에 막히면 다른 아이템으로 바꾼다']
  ],
  timeline: [
...
/* ---------------------------------------------------------------- 7 */
{
  ...
  lessons: [
    ...
    ['번 돈은 다음 판에', '크로스파이어로 번 돈을 로스트아크에 7년 넘게 부었다.', 4, '크게 벌면 쌓아 두고 지킨다']
  ],
  timeline: [
...
/* ---------------------------------------------------------------- 8 */
{
  ...
  lessons: [
    ...
    ['상품이 아니라 시간을 판다', '밤 11시 주문, 아침 7시 도착. 고객의 아침 시간을 팔았다.', 2, '더 싸게, 더 많이 팔 궁리만 한다'],
    ['아무도 안 하는 어려운 일', '밤새 돌아가는 물류라는 어려움이 그대로 진입장벽이 됐다.', 2, '어렵고 힘든 일은 피한다']
  ],
  timeline: [
